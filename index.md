...
Скорее всего, вы хотели перейти по ссылке на один из проектов, например на сайт с итоговыми задачами по программированию из плейлиста 'Основы Python 3.x' (задачи будут выложены после окончания блока базового синтаксиса, потом после окончания алгоритмов и структур и данных и т.д.)
